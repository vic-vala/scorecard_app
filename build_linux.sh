...
# FOLLOW THIS EXECUTION COMMAND: PYTHON_BIN="./.venv/bin/python3" ./build_linux.sh
...
echo "  ($PYTHON_CMD) test_frozen.py"
echo ""
echo "Note: This Linux build is for testing only."
echo "For Windows distribution, use build_windows.bat"
echo ""
