...
# FOLLOW THIS EXECUTION COMMAND: PYTHON_BIN="./.venv/bin/python3" ./builds/linux/test_dev.sh
...
case $option in
    ...
    2)
        ...
        # Create marker file to skip setup (in resources directory)
        mkdir -p resources
        touch resources/.setup_complete
    ...
    4)
        ...
        $PYTHON_CMD builds/linux/test_frozen.py
        ;;
    *)
